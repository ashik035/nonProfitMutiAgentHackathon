...
const EDGE_FUNCTIONS: EdgeFunction[] = [
  ...
  { name: "executive-daily-briefer", category: "AI", description: "ED morning briefing", required: false, envVars: ["OPENAI_API_KEY"] },
  { name: "donor-churn-risk", category: "AI", description: "Donor churn risk scoring", required: false, envVars: ["ANTHROPIC_API_KEY", "OPENAI_API_KEY"] },
  { name: "strategic-insights", category: "AI", description: "RAG grant + donor insights", required: false, envVars: ["OPENAI_API_KEY", "ANTHROPIC_API_KEY"] },
...
export default function DeploymentStatus() {
  ...
  const testFunction = async (functionName: string) => {
    ...
    const testPayloads: Record<string, object> = {
      ...
      'executive-daily-briefer': { ping: true },
      'donor-churn-risk': { ping: true },
      'strategic-insights': { ping: true },
